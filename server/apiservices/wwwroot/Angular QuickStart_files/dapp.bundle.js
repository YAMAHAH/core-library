...
/***/ "./node_modules/css-loader/index.js!./src/app/common/page-loading/page-loading-comp.css":
/***/ function(module, exports, __webpack_require__) {
...
var AppStore = (function () {
    ...
    AppStore.prototype.purge = function () {
...
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var style = __webpack_require__("./styles.css");
__webpack_require__("./src/app/news/news.scss");
__webpack_require__("./src/app/app.scss");
var AppComponent = (function () {
    function AppComponent() {
        this.name = 'Angular Aot Complier';
    }
...
var staticnews_module_1 = __webpack_require__("./src/app/test/staticnews.module.ts");
...
AppModule = __decorate([
    core_1.NgModule({
        imports: [
            platform_browser_1.BrowserModule, http_1.HttpModule, page_loading_module_1.PageLoadingModule.forRoot(), staticnews_module_1.StaticNewsModule,
            router_1.RouterModule.forRoot(app_router_1.rootRouterConfig, { useHash: false })
        ],
        declarations: [app_component_1.AppComponent],
        providers: app_service_1.appRootProviders.slice()
    }),
    __metadata("design:paramtypes", [])
], AppModule);
...
var staticnews_component_1 = __webpack_require__("./src/app/test/staticnews.component.ts");
function ConfigAppRoutes(approutes) {
    approutes.forEach(function (r) {
        var guards = r.canActivate;
        if (!!!guards) {
            guards = [];
        }
        guards.push(page_animate_guard_1.CanPageAnimateGuard);
        r.canActivate = guards;
        var resolveData = r.resolve;
        if (!!!resolveData) {
            resolveData = {};
        }
        resolveData["default"] = my_data_resolver_1.MyDataResolver;
        r.resolve = resolveData;
    });
    return approutes;
}
exports.ConfigAppRoutes = ConfigAppRoutes;
exports.rootRouterConfig = [
    { path: '', redirectTo: 'pc', pathMatch: 'full' },
    {
        path: 'mobile',
        loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* nsure */(2).then((function (require) { resolve(__webpack_require__("./src/app/common/mobile-index/mobile-index.module.ts")['MobileIndexModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); }
    },
    {
        path: 'pc',
        loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* nsure */(0).then((function (require) { resolve(__webpack_require__("./src/app/common/pc-index/index.module.ts")['IndexModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); }
    },
    {
        path: 'auth',
        loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* nsure */(1).then((function (require) { resolve(__webpack_require__("./src/app/common/auth/auth.module.ts")['AuthModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); }
    },
    {
        path: 'test',
        component: staticnews_component_1.StaticNewsComponent
    },
...
var blockui_service_1 = __webpack_require__("./src/app/services/blockui.service.ts");
var app_state_service_1 = __webpack_require__("./src/app/services/app.state.service.ts");
exports.appRootProviders = [
    auth_guard_1.AuthGuard,
    auth_service_1.AuthService,
    my_data_resolver_1.MyDataResolver,
    load_script_service_1.LoadScriptService,
    page_animate_guard_1.CanPageAnimateGuard,
...
var AuthGuard = (function () {
    ...
    AuthGuard.prototype.canActivate = function (next, state) {
        ...
        this.router.navigate(['/auth/login', { target: decodeURIComponent(state.url) }], { queryParams: {}, fragment: '' });
        return false;
    };
    return AuthGuard;
}());
...
/***/ "./src/app/common/my-data-resolver.ts":
/***/ function(module, exports, __webpack_require__) {
...
var MyDataResolver = (function () {
    function MyDataResolver(pageLoadService) {
        this.pageLoadService = pageLoadService;
    }
    MyDataResolver.prototype.resolve = function (route, state) {
        var _this = this;
        setTimeout(function () {
            _this.pageLoadService.hidePageLoading();
        }, 3000);
        return Observable_1.Observable.of(Observable_1.Observable.timer(100, 100).take(1000).toArray()).delay(3000);
    };
    return MyDataResolver;
}());
MyDataResolver = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [page_loading_1.PageLoadingService])
], MyDataResolver);
exports.MyDataResolver = MyDataResolver;


/***/ },

/***/ "./src/app/common/page-animate-guard.ts":
/***/ function(module, exports, __webpack_require__) {
...
var load_script_service_1 = __webpack_require__("./src/app/services/load-script-service.ts");
var page_loading_1 = __webpack_require__("./src/app/common/page-loading/index.ts");
var CanPageAnimateGuard = (function () {
    function CanPageAnimateGuard(loadScriptService, pageLoadingService) {
        this.loadScriptService = loadScriptService;
        this.pageLoadingService = pageLoadingService;
    }
    CanPageAnimateGuard.prototype.canActivate = function (route, state) {
        var _this = this;
        return this.loadScriptService
            .loadSnapSvg
            .then(function (snap) {
            _this.pageLoadingService.showPageLoading(page_loading_1.AnimateEffectEnum.random);
            return true;
        });
    };
    return CanPageAnimateGuard;
}());
CanPageAnimateGuard = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [load_script_service_1.LoadScriptService, page_loading_1.PageLoadingService])
], CanPageAnimateGuard);
exports.CanPageAnimateGuard = CanPageAnimateGuard;


/***/ },

/***/ "./src/app/common/page-loading/animate-effect-enum.ts":
/***/ function(module, exports) {

"use strict";
"use strict";
var AnimateEffectEnum;
(function (AnimateEffectEnum) {
    AnimateEffectEnum[AnimateEffectEnum["random"] = 0] = "random";
    AnimateEffectEnum[AnimateEffectEnum["LazyStretch"] = 1] = "LazyStretch";
    AnimateEffectEnum[AnimateEffectEnum["Circle"] = 2] = "Circle";
    AnimateEffectEnum[AnimateEffectEnum["Spill"] = 3] = "Spill";
    AnimateEffectEnum[AnimateEffectEnum["FrameIt"] = 4] = "FrameIt";
    AnimateEffectEnum[AnimateEffectEnum["TunnelVision"] = 5] = "TunnelVision";
    AnimateEffectEnum[AnimateEffectEnum["WindscreenWiper"] = 6] = "WindscreenWiper";
    AnimateEffectEnum[AnimateEffectEnum["JammedBlind"] = 7] = "JammedBlind";
    AnimateEffectEnum[AnimateEffectEnum["Parallelogram"] = 8] = "Parallelogram";
    AnimateEffectEnum[AnimateEffectEnum["Tilted"] = 9] = "Tilted";
    AnimateEffectEnum[AnimateEffectEnum["LateralSwipe"] = 10] = "LateralSwipe";
    AnimateEffectEnum[AnimateEffectEnum["Wave"] = 11] = "Wave";
    AnimateEffectEnum[AnimateEffectEnum["Origami"] = 12] = "Origami";
    AnimateEffectEnum[AnimateEffectEnum["Curtain"] = 13] = "Curtain";
})(AnimateEffectEnum = exports.AnimateEffectEnum || (exports.AnimateEffectEnum = {}));
;


/***/ },

/***/ "./src/app/common/page-loading/index.ts":
/***/ function(module, exports, __webpack_require__) {

"use strict";
"use strict";
var animate_effect_enum_1 = __webpack_require__("./src/app/common/page-loading/animate-effect-enum.ts");
exports.AnimateEffectEnum = animate_effect_enum_1.AnimateEffectEnum;
var page_loading_service_1 = __webpack_require__("./src/app/common/page-loading/page-loading-service.ts");
exports.PageLoadingService = page_loading_service_1.PageLoadingService;
var page_loading_effects_1 = __webpack_require__("./src/app/common/page-loading/page-loading-effects.ts");
exports.pageLoadingEffects = page_loading_effects_1.pageLoadingEffects;
var page_loading_module_1 = __webpack_require__("./src/app/common/page-loading/page-loading-module.ts");
exports.PageLoadingModule = page_loading_module_1.PageLoadingModule;
var page_loading_comp_1 = __webpack_require__("./src/app/common/page-loading/page-loading-comp.ts");
exports.PageLoadingComponent = page_loading_comp_1.PageLoadingComponent;
var page_load_action_enum_1 = __webpack_require__("./src/app/common/page-loading/page-load-action-enum.ts");
exports.PageLoadActionEnum = page_load_action_enum_1.PageLoadActionEnum;


/***/ },

/***/ "./src/app/common/page-loading/page-load-action-enum.ts":
/***/ function(module, exports) {

"use strict";
"use strict";
var PageLoadActionEnum;
(function (PageLoadActionEnum) {
    PageLoadActionEnum[PageLoadActionEnum["show"] = 1] = "show";
    PageLoadActionEnum[PageLoadActionEnum["hide"] = 2] = "hide";
})(PageLoadActionEnum = exports.PageLoadActionEnum || (exports.PageLoadActionEnum = {}));


/***/ },

/***/ "./src/app/common/page-loading/page-loading-comp.css":
/***/ function(module, exports, __webpack_require__) {


        var result = __webpack_require__("./node_modules/css-loader/index.js!./src/app/common/page-loading/page-loading-comp.css");
...
/***/ "./src/app/common/page-loading/page-loading-comp.html":
/***/ function(module, exports) {

module.exports = "<div id=\"pageloader\" [ngClass]=\"getClass()\">\r\n    <svg id=\"paper\" xmlns=\"http://www.w3.org/2000/svg\" width=\"100%\" height=\"100%\" viewBox=\"0 0 80 60\" preserveAspectRatio=\"none\">\r\n        <path />\r\n    </svg>\r\n</div>"

/***/ },

/***/ "./src/app/common/page-loading/page-loading-comp.ts":
/***/ function(module, exports, __webpack_require__) {
...
var PageLoadingComponent = (function () {
    function PageLoadingComponent(pageLoadService, loadScriptService) {
        var _this = this;
        this.pageLoadService = pageLoadService;
        this.loadScriptService = loadScriptService;
        ...
        this.effect = 'random';
        this.timeOut = 500;
        this.checkStream = Observable_1.Observable.interval(100);
        this.pageLoadService.pageLoadingStream
            .subscribe(function (pageAction) {
            if (pageAction.method === page_loading_1.PageLoadActionEnum.show) {
                _this.showLoading(pageAction.effect);
            }
            if (pageAction.method === page_loading_1.PageLoadActionEnum.hide) {
                _this.Hide();
            }
        });
    }
    ...
    PageLoadingComponent.prototype.showLoading = function (effect) {
        var _this = this;
        var checkSubscriber = this.checkStream.subscribe(function (i) {
            if (_this.pageLoadService.isShow === false && _this.pageLoadService.isLoading) {
                _this.pageLoadService.isLoading = false;
            }
            if (!_this.pageLoadService.isShow && !_this.pageLoadService.isLoading) {
                checkSubscriber.unsubscribe();
            }
        });
        this.AnimateInit({ el: "#paper", effect: page_loading_1.AnimateEffectEnum[effect] });
        this.Show(page_loading_1.AnimateEffectEnum[effect]);
        //  setTimeout(() => { this.Hide(); }, 1860);
    };
    Object.defineProperty(PageLoadingComponent.prototype, "path", {
        get: function () {
    ...
    PageLoadingComponent.prototype.AnimateInit = function (options) {
    ...
    PageLoadingComponent.prototype.GetOpt = function (newEffect) {
        var effect, effects, effectObj, initialPath, openingSteps, openingStepsStr, openingStepsTotal, closingSteps, closingStepsStr, closingStepsTotal, animateOpt, speedOut, easingOut;
        effect = newEffect || effect;
        effects = Object.keys(page_loading_1.pageLoadingEffects);
        if (effect === 'random' || effects.indexOf(effect) < 0) {
            effect = effects[Math.floor(Math.random() * 13)];
        }
        effectObj = page_loading_1.pageLoadingEffects[effect];
    ...
    PageLoadingComponent.prototype.getClass = function () {
        return {
    ...
    PageLoadingComponent.prototype.Show = function (newEffect) {
        var _this = this;
        var animateOpt;
        ...
        var cbk = function () { return _this.pageLoadService.isLoading = true; };
    ...
    PageLoadingComponent.prototype.Hide = function () {
        ...
        this.pageLoadService.isLoading = false;
        var cbk = function () {
            _this.pageLoadService.isShow = false;
    ...
    PageLoadingComponent.prototype.AnimateSVG = function (dir, animateOpt, cbk) {
        var _this = this;
        var pos = 0, steps = dir === 'out' ? animateOpt.closingSteps : animateOpt.openingSteps, stepsTotal = dir === 'out' ? animateOpt.closingStepsTotal : animateOpt.openingStepsTotal, speed = dir === 'out' ? animateOpt.speedOut : animateOpt.speedIn, easing = dir === 'out' ? animateOpt.easingOut : animateOpt.easingIn, nextStep;
        ...
        nextStep = function (pos) {
            ...
            _this.path.animate({ 'path': steps[pos] }, speed, easing, function () {
                nextStep(pos);
            });
            pos++;
        };
...
PageLoadingComponent = __decorate([
    core_1.Component({
        ...
        template: __webpack_require__("./src/app/common/page-loading/page-loading-comp.html"),
        styles: [__webpack_require__("./src/app/common/page-loading/page-loading-comp.css")],
    }),
    __metadata("design:paramtypes", [page_loading_1.PageLoadingService, load_script_service_1.LoadScriptService])
...
/***/ "./src/app/common/page-loading/page-loading-effects.ts":
/***/ function(module, exports) {

"use strict";
"use strict";
exports.pageLoadingEffects = {
    'LazyStretch': {
...
exports.pageLoadingTemplate = "<div id=\"pageloader\" class=\"pageload-overlay\">\n                                    <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"100%\" height=\"100%\" viewBox=\"0 0 80 60\"  preserveAspectRatio=\"none\">\n                                    <path />\n                                    </svg>\n                                    </div>'";


/***/ },

/***/ "./src/app/common/page-loading/page-loading-module.ts":
/***/ function(module, exports, __webpack_require__) {
...
var page_loading_comp_1 = __webpack_require__("./src/app/common/page-loading/page-loading-comp.ts");
var page_loading_service_1 = __webpack_require__("./src/app/common/page-loading/page-loading-service.ts");
var PageLoadingModule = PageLoadingModule_1 = (function () {
    function PageLoadingModule() {
    }
    PageLoadingModule.forRoot = function () {
        return {
            ngModule: PageLoadingModule_1,
            providers: [page_loading_service_1.PageLoadingService]
        };
    };
    return PageLoadingModule;
}());
PageLoadingModule = PageLoadingModule_1 = __decorate([
    core_1.NgModule({
        imports: [common_1.CommonModule],
        declarations: [page_loading_comp_1.PageLoadingComponent],
        exports: [page_loading_comp_1.PageLoadingComponent]
    }),
    __metadata("design:paramtypes", [])
], PageLoadingModule);
exports.PageLoadingModule = PageLoadingModule;
var PageLoadingModule_1;


/***/ },

/***/ "./src/app/common/page-loading/page-loading-service.ts":
/***/ function(module, exports, __webpack_require__) {
...
var Subject_1 = __webpack_require__("./node_modules/rxjs/Subject.js");
var BehaviorSubject_1 = __webpack_require__("./node_modules/rxjs/BehaviorSubject.js");
var index_1 = __webpack_require__("./src/app/common/page-loading/index.ts");
var defaultState = {
    // define your initial state here
    ready: false
};
var PageLoadingService = (function () {
    function PageLoadingService() {
        this.pageLoadingStream = new Subject_1.Subject();
        this.pageReady = new BehaviorSubject_1.BehaviorSubject(defaultState);
    }
    PageLoadingService.prototype.showPageLoading = function (effect) {
        this.subscription = this.pageReady.subscribe(function (ready) {
            if (ready.ready) {
            }
        });
        this.pageLoadingStream.next({ method: index_1.PageLoadActionEnum.show, effect: effect });
    };
    PageLoadingService.prototype.hidePageLoading = function () {
        this.pageLoadingStream.next({ method: index_1.PageLoadActionEnum.hide });
...
var AppStateService = (function () {
    function AppStateService() {
        // left:BehaviorSubject<{action:string;data:any;}> = new BehaviorSubject();
        this.left = new Subject_1.Subject();
    }
...
var AuthService = (function () {
    function AuthService(http, httpService, router, loadSrciptService) {
        this.http = http;
        this.httpService = httpService;
        this.router = router;
        this.loadSrciptService = loadSrciptService;
        this.isLoggedIn = false;
        this.port = 5000;
        //192.168.10.233
        this.signupUrl = 'http://127.0.0.1:' + this.port + '/api/UserManager/Signup';
        this.loginUrl = 'http://127.0.0.1:' + this.port + '/api/token';
    ...
    AuthService.prototype.signup = function (username, password) {
        ...
        return this.http.post(this.signupUrl, postBody, requestOptions)
            ...
            return _this.getToken(_this.loginUrl, username, resJson.usersign);
        }, function (error) {
            _this.authError.next(error.text());
        });
    };
    AuthService.prototype.login = function (username, password) {
        var _this = this;
        return this.loadSrciptService.loadCryptoJS.then(function (js) {
            var sign = CryptoJS.HmacSHA1(username, password).toString(CryptoJS.enc.Base64);
            return _this.getToken(_this.loginUrl, username, sign);
        });
    };
    AuthService.prototype.post = function (url, username, password) {
        var _this = this;
        return this.loadSrciptService.loadCryptoJS.then(function (js) {
            var header = new http_1.Headers();
            var requestOptions = new http_1.RequestOptions();
            ...
            var sign = CryptoJS.HmacSHA1(username, password).toString(CryptoJS.enc.Base64);
            var postBody = "username=" + username + "&usersign=" + sign;
            return _this.http.post(url, postBody, requestOptions)
                .toPromise()
                .then(function (response) {
                var resJson = response.json();
                _this.isLoggedIn = true;
                _this.jwt = resJson.access_token;
                localStorage.setItem('jwt_token', _this.jwt);
            }, function (error) {
                _this.authError.next(error.text());
            });
        });
    };
    AuthService.prototype.getToken = function (url, username, usersign) {
        var _this = this;
        var header = new http_1.Headers();
        var requestOptions = new http_1.RequestOptions();
        header.append("Content-Type", "application/x-www-form-urlencoded");
        requestOptions.headers = header;
        requestOptions.url = url;
        var postBody = "username=" + username + "&usersign=" + usersign;
...
/***/ "./src/app/services/blockui.service.ts":
/***/ function(module, exports, __webpack_require__) {
...
var HttpService = (function () {
    ...
    HttpService.prototype.httpPost = function (object, url) {
        ...
        return this.http.post(url, body, options)
            .map(function (response) { return _this.parseResponse(response, _this.blockUIService, true); })
    ...
    HttpService.prototype.httpPostWithNoBlock = function (object, url) {
        ...
        var options = new http_2.RequestOptions({ headers: headers });
        return this.http.post(url, body, options)
            .map(function (response) { return _this.parseResponse(response, _this.blockUIService, false); })
...
/***/ "./src/app/services/load-script-service.ts":
/***/ function(module, exports, __webpack_require__) {
...
var core_1 = __webpack_require__("./node_modules/@angular/core/index.js");
var LoadScriptService = (function () {
    function LoadScriptService() {
        this.loadlibs = new Map();
    }
    LoadScriptService.prototype.load = function (src) {
        var _this = this;
        if (!!!this.loadlibs.has(src)) {
            var doc_1 = document;
            return new Promise(function (resolve, reject) {
                var script = doc_1.createElement('script');
                if (!src) {
                    new Error('src');
                }
                script.src = src;
                doc_1.querySelector('head').appendChild(script);
                script.onload = function () {
                    resolve();
                    _this.loadlibs.set(src, src);
                    script.remove();
                };
    ...
    LoadScriptService.prototype.loadCSS = function (src) {
        var _this = this;
        if (!!!this.loadlibs.has(src)) {
            var doc_2 = document;
            return new Promise(function (resolve, reject) {
                var link = doc_2.createElement('link');
                if (!src) {
                    new Error('src');
                }
                link.href = src;
                link.rel = "stylesheet";
                doc_2.querySelector('head').appendChild(link);
    ...
    Object.defineProperty(LoadScriptService.prototype, "loadSnapSvg", {
        get: function () {
    ...
    Object.defineProperty(LoadScriptService.prototype, "loadCryptoJS", {
        get: function () {
    ...
    Object.defineProperty(LoadScriptService.prototype, "loadLodash", {
        get: function () {
    ...
    Object.defineProperty(LoadScriptService.prototype, "loadBootstrapCSS", {
        get: function () {
    ...
    Object.defineProperty(LoadScriptService.prototype, "loadFlexboxGridCSS", {
        get: function () {
    ...
    Object.defineProperty(LoadScriptService.prototype, "loadAnimateCSS", {
        get: function () {
...
LoadScriptService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [])
], LoadScriptService);
exports.LoadScriptService = LoadScriptService;


/***/ },

/***/ "./src/app/test/childnews.component.ts":
/***/ function(module, exports, __webpack_require__) {
...
var ChildNewsComponent = (function () {
    function ChildNewsComponent(activeRoute) {
    ...
    ChildNewsComponent.prototype.ngOnInit = function () {
        ...
        this.activeRoute
            ...
            if (url)
                _this.paraId = decodeURIComponent(url);
        });
    };
...
/***/ "./src/app/test/staticnews.component.ts":
/***/ function(module, exports, __webpack_require__) {
...
/***/ "./src/app/test/staticnews.module.ts":
/***/ function(module, exports, __webpack_require__) {
...
var common_1 = __webpack_require__("./node_modules/@angular/common/index.js");
var router_1 = __webpack_require__("./node_modules/@angular/router/index.js");
var staticnews_router_1 = __webpack_require__("./src/app/test/staticnews.router.ts");
var staticnews_component_1 = __webpack_require__("./src/app/test/staticnews.component.ts");
var childnews_component_1 = __webpack_require__("./src/app/test/childnews.component.ts");
...
/***/ "./src/app/test/staticnews.router.ts":
/***/ function(module, exports, __webpack_require__) {
...
exports.rootRouterConfig = [
    {
        path: 'test', component: staticnews_component_1.StaticNewsComponent, children: [
            { path: 'child/:id', component: childnews_component_1.ChildNewsComponent }
        ]
    }
];
...
var app_component_1 = __webpack_require__("./src/app/app.component.ts");
var app_store_1 = __webpack_require__("./src/app-store.ts");
var app_module_hmr_1 = __webpack_require__("./src/app/app.module.hmr.ts");
var MainModule = (function () {
    function MainModule(appRef, appStore) {
        this.appRef = appRef;
        this.appStore = appStore;
    }
    MainModule.prototype.hmrOnInit = function (store) {
    ...
    MainModule.prototype.hmrOnDestroy = function (store) {
    ...
    MainModule.prototype.hmrAfterDestroy = function (store) {
...
/***/ function(module, exports, __webpack_require__) {
        ...
        var result = __webpack_require__("./node_modules/css-loader/index.js!./styles.css");
...
module.exports = __webpack_require__("./src/main.hmr.ts");
