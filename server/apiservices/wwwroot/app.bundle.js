...
exports.rootRouterConfig = [
    ...
    {
        path: 'pc',
        loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* nsure */(1).then((function (require) { resolve(__webpack_require__("./src/app/common/pc-index/index.module.ts")['IndexModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); }
    },
    {
        path: 'auth',
        loadChildren: function () { return new Promise(function (resolve) { __webpack_require__.e/* nsure */(0).then((function (require) { resolve(__webpack_require__("./src/app/common/auth/auth.module.ts")['AuthModule']); }).bind(null, __webpack_require__)).catch(__webpack_require__.oe); }); }
    },
    {
        path: 'test',
...
module.exports = "<!--<!--<button (click)=\"showLoading()\">Loading</button>-->\r\n<!--<button (click)=\"AnimateInit\">draw</button>-->\r\n<div id=\"pageloader\" [ngClass]=\"getClass()\">\r\n    <svg id=\"paper\" xmlns=\"http://www.w3.org/2000/svg\" width=\"100%\" height=\"100%\" viewBox=\"0 0 80 60\" preserveAspectRatio=\"none\">\r\n        <path />\r\n    </svg>\r\n</div>"
...
var AuthService = (function () {
    function AuthService(http, httpService, router, loadSrciptService) {
        ...
        this.port = 5000;
        this.signupUrl = 'http://localhost:' + this.port + '/api/UserManager/Signup';
        this.loginUrl = 'http://localhost:' + this.port + '/api/token';
