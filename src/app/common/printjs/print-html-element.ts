export default class PrintHtmlElement {
    static printElement(element: HTMLElement, opts: htmlOptions) {
        let elementHtml = element.outerHTML;

        this._print(elementHtml, opts);
    }
    static printHtml(html: string, opts: htmlOptions) {
        this._print(html, opts);
    }
    private static _print(html: string, opts: htmlOptions) {
        opts = opts || {};
        opts = {
    ...
    private static _callPrint(printWindow: any, iframe: HTMLIFrameElement) {
    ...
    private static _getMarkup(elementHtml: string, opts: htmlOptions) {
