...
import { DEFAULT_BREAKPOINTS_PROVIDER, BreakPointProviderOptions, CUSTOM_BREAKPOINTS_PROVIDER_FACTORY } from './breakpoints/break-points-provider';
...
export class MediaQueriesModule {
    ...
    static forRoot(breakpoints: BreakPoint[],
        options?: BreakPointProviderOptions): ModuleWithProviders {
        return {
            ngModule: MediaQueriesModule,
            providers: [
