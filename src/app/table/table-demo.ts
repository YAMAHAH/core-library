...
import { ScrollableView } from '../components/datatable/datatable';
...
export class TableDemo {
  ...
  @ViewChild('masterDetailTable', { read: ElementRef }) masterDetailCard: ElementRef;
  ...
  connect() {
    ...
    this.masterDetailCard.nativeElement.scrollIntoView();
  }
